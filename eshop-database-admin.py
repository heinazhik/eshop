...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Create a horizontal layout for buttons and tab widget
        ...
        self.refresh_button.clicked.connect(self.refresh_tab)
        top_layout.addWidget(self.refresh_button)
        
        # Create export button
        self.export_button = QPushButton("Export")
        self.export_button.clicked.connect(self.export_tab_data)
        ...
        tabs.addTab(self.products_tab, "Products")
...
class ProductsTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.table.setHorizontalHeaderLabels([
            "ID", "Name", "Category", "Price", "Stock", "Description", "Featured"
        ])
...
class CustomersTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.table.setColumnCount(7)
        self.table.setHorizontalHeaderLabels([
            "ID", "Name", "Email", "Phone", "Address", "Registration Date", "Newsletter"
        ])
        layout.addWidget(self.table)
...
class OrdersTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.table.setHorizontalHeaderLabels([
            "ID", "Customer", "Status", "Total Amount", "Created At"
        ])
        layout.addWidget(self.table)
